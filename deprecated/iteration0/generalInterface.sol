...
contract IMarketPlace{
	...
	*/
	function updateDataSourcePrice(bytes32 _dataSourceName, uint256 _newPrice) returns (bool);
	/*
	...
	*/
	function isValidSubscription(address _subscriber, bytes32 _dataSourceName) public external returns (bool);
	/*
	...
	*/
	function isActiveDataSource(bytes32 _dataSourceName) public external returns (bool);
	/***********
	** events **
	************/
